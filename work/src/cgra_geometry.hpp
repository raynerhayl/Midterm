...
namespace cgra {
	...
	void cgraSphere(float radius, int slices=10, int stacks=10, bool wire=false) {
	...
	void cgraCone(float base_radius, float height, int slices=10, int stacks=10, bool wire=false) {
